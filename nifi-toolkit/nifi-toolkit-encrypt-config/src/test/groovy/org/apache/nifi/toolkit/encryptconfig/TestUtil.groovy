...
class TestUtil {
    ...
    protected static final String KEY_HEX = isUnlimitedStrengthCryptoAvailable() ? KEY_HEX_256 : KEY_HEX_128

    protected static final String PASSWORD = "thisIsABadPassword"
